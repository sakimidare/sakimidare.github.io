...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/banner1.jpeg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	links: [
		{
			...
			url: "mailto:sakimidare@outlook.com",
		},
		{
			name: "Bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/285741399",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/sakimidare",
		},
	],
};
...
export const expressiveCodeConfig: ExpressiveCodeConfig = {
	...
	// Dark theme, used when the site is in dark mode
	theme: "github-dark",
	// Light theme, used when the site is in light mode
